...
class FormSubmit extends Event
{
    ...
    {
        return __('Form Submit', WPNE_WPF);
    }
    ...
    {
        $this->subject = __('Form "[form-name]" submit', WPNE_WPF);
        $this->message = __("Form \"[form-name]\" submit\n\n[form-all-fields]", WPNE_WPF);
    ...
    public function tag_labels($form = null)
    {
        ...
        return array_merge([
            __('Form', WPNE_WPF) => WPForms::labels($form),
        ], parent::tag_labels());
    }
